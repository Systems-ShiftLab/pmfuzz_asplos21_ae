    ...
    if (s_it->it_flags & ITEM_CHUNKED) {
        ...
        while (sch && dch && remain) {
            ...
            memcpy(dch->data + dch->used, sch->data + copied, todo);
                ...
                // dprintf(3, "PMFuzz found: memcached_3\n");
            }
#endif
            dch->used += todo;
            copied += todo;
    ...
    if (comm == NREAD_APPEND) {
        if (new_it->it_flags & ITEM_CHUNKED) {
            ...
            if (new_it->it_flags & ITEM_PSLAB) {
                ...
                dprintf(3, "PMFuzz found: memcached_8\n");
                return 0;
            }
#endif
        ...
        if (new_it->it_flags & ITEM_CHUNKED) {
            ...
            if (new_it->it_flags & ITEM_PSLAB) {
                ...
                dprintf(3, "PMFuzz found: memcached_9\n");
                return 0;
            }
#endif
    ...
    while (!stop) {
        ...
        case conn_nread:
            if (c->rlbytes == 0) {
                ...
                fprintf(stderr, "RoIBegin\n");
                complete_nread(c);
		        XFDetector_RoIEnd(1, PRE_FAILURE);
                fprintf(stderr, "RoIEnd\n");
                break;
            }
                ...
                if (c->rbytes > 0) {
                    ...
                    if (c->ritem != c->rcurr) {
                        ...
                        memmove(c->ritem, c->rcurr, tocopy);
                            ...
                            #ifdef MEMCACHED_MEMCACHED_5
                            pmem_memmove(c->ritem, c->rcurr, tocopy, PMEM_F_MEM_NOFLUSH);
                            dprintf(3, "PMFuzz found: memcached_5\n");
                            #else
